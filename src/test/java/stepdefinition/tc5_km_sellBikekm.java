...
public class tc5_km_sellBikekm {
	WebDriver driver;
	@Given("to fill the fields of form user is in sell used bike page")
	public void to_fill_the_fields_of_form_user_is_in_sell_used_bike_page() throws InterruptedException {
	...
	@When("user enter the invalid  data in km field {string},{string},{string},{string},{string},{string},{string},{string},{string},{string} and click on post ad button")
	public void user_enter_the_invalid_data_in_km_field_and_click_on_post_ad_button(String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10) {
	...
	public void error_message_should_be_displayed_for_km_field() {
			driver.quit();
